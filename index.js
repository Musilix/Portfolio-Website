...
$(document).ready(function(){
	...
	var content5 = document.getElementById("actual_collapsable5");
...
//
	...
	$("#collapsable5").click(function(){
		showCollapsable(5);
		currentOpen = content5;
	});
...
//////////////////////////////////////////////////////////////////////////
	let height_val = (maxHeight / 3) - 50 + "px"
	$("#header-text").css({
			"height": height_val,
...
//////////////////////////////////////////////////////////////////////////
	...
	$(window).resize(function(){
		...
		if(onPage == 1){
			...
			$("#chimchom2-descriptive, #actual_collapsable1, #actual_collapsable2, #actual_collapsable3, #actual_collapsable4, #actual_collapsable5").css({
				width: newWidthHolder
			});
			setWidthOfDescriptions(parseInt(newWidthHolder));
		}else if(onPage == 3){
